...
const OfferPricing = () => {
  const { user } = useAuth();
  const { pageId = 'pricing' } = useParams();
  const {
    comments,
    loading,
    error,
  ...
  return (
    <div className="page-container">
      <h2>Offer Pricing SKUs</h2>
      <p>Manage product pricing and SKU information.</p>
...
const ProtectedOfferPricing = () => (
  <PrivateRoute requiredPermission={{ page: 'pricing', action: PERMISSIONS.VIEW }}>
    <OfferPricing />
  </PrivateRoute>
);

export default ProtectedOfferPricing;