...
const MarketingList = () => {
  const { user } = useAuth();
  const { pageId = 'marketing' } = useParams();
  const {
    comments,
    loading,
    error,
  ...
  return (
    <div className="page-container">
      ...
      <p>Manage marketing campaigns and strategies.</p>
...
const ProtectedMarketingList = () => (
  <PrivateRoute requiredPermission={{ page: 'marketing', action: PERMISSIONS.VIEW }}>
    <MarketingList />
  </PrivateRoute>
);

export default ProtectedMarketingList;